...
// Credit: https://github.com/TheCherno/Hazel/blob/master/Hazel/src/Hazel/Debug/Instrumentor.h
...
#define PE_PROFILE 1
	...
	#define PE_PROFILE_SCOPE(name) ::PaulEngine::InstrumentationTimer timer##__LINE__(name);
